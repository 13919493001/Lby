...
export default {
  ...
  methods: {
    ...
    goodsDatail() {
      ...
      api.personal.seckillDetail(this.id).then(res => {
        ...
        this.productId=this.comList.product_id        
        api.personal.addCar({productId:this.productId,cartNum:this.carNum,new:"1",secKillId:this.id}).then((res)=>{
