<template>
  <div class="order">
    <div class="content">
      ...
      <infos @order="order" :idList='idList' :num='num' :comNum="comNum" :groupId="groupId" :numList="numList" :usual="usual" :Integrals="Integrals" :cartIds="cartIds" :payMoney="payMoney" :cartList="cartList" />
    </div>
...
<script>
import infos from "@/components/market/infos";
...
export default {
  ...
  created(){
    ...
    this.cartList=this.$route.params.cartId.split(',')
    console.log(this.idList,this.cartList, this.cartIds);
